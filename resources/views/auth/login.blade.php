        ...
        <div class="w-full px-6 md:px-8 xl:px-12 py-15 xl:w-4/7 flex flex-col justify-center">
            ...
            <div class="flex flex-row justify-between mt-5 items-center">
              <label for="remember_me" class="flex items-center cursor-pointer"
                ...
                />
                <span type="checkbox" name="remember_me" id="remember_me" class=" text-sm py-1.5 px-3 rounded-md mr-2 border-1 bg-transparent peer-checked:border-orange peer-checked:border-2 peer-checked:bg-peach peer-checked:font-bold peer-checked:text-blue-dark transition-all duration-100 hover:bg-peach"/>Ingat saya</span>
            ...
            <div class="flex flex-col text-center mt-5">
              ...
              <p class="mt-7">
                Belum punya akun?
                <a href="/register" class="text-orange font-bold hover:opacity-80 underline"
                  >Daftar</a
                >
                sekarang!
              </p>

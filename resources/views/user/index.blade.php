<x-layout>
    ...
    <section id="catalogue" class="py-30 text-black">
        ...
        <div class="flex flex-col md:flex-row justify-between mb-5 items-start md:items-center gap-4 md:gap-0">
            @php
         ...
         <div class="flex flex-col rounded-md shadow-md overflow-hidden px-4 py-7 md:p-10">
            ...
            <form action="/dashboard/{{ $user->username }}" method="POST" class="flex flex-col w-full md:w-1/4">
                @csrf
                @method('PUT')
